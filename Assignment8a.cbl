       ...
       01  WS-DIVIDING-FACTOR PIC 999V99.
      ...
      *    c) Adjust the number of blank lines after the region. 
           WRITE PRINTREC FROM WS-REGION-END-LINE AFTER 2
      ...
      *    b) Adjust the number of blank lines before the region.
           WRITE PRINTREC FROM WS-REGION-START-LINE AFTER 3
           ADD 1 TO WS-LINE-CNT
           .
       WRITE-DETAIL.
